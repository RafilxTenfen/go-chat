...
build/linux-amd64/bot: $(bot_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/bot

build/darwin-amd64/bot: $(bot_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=darwin $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/bot

build/linux-arm7/bot: $(bot_SOURCES) $(SOURCES)
	env GOARM=7 GOARCH=arm GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/bot
...
build/linux-amd64/user: $(user_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/user

build/darwin-amd64/user: $(user_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=darwin $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/user

build/linux-arm7/user: $(user_SOURCES) $(SOURCES)
	env GOARM=7 GOARCH=arm GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/user
...
build/linux-amd64/chatapi: $(chatapi_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/chatapi

build/darwin-amd64/chatapi: $(chatapi_SOURCES) $(SOURCES)
	env GOARCH=amd64 GOOS=darwin $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/chatapi

build/linux-arm7/chatapi: $(chatapi_SOURCES) $(SOURCES)
	env GOARM=7 GOARCH=arm GOOS=linux $(GOBUILD) $(FLAGS) $(LDFLAGS) -o $@ ./cmd/chatapi
